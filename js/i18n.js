window.I18N = {
  no: {
    ...
    mobile_webapp_link: "📱 Webapp for mobilbrukere",
    logout: "Logg ut",
    new_entry: "Ny loggføring",
    entry_type_label: "Type",
    delete_entry: "Slett",
    confirm_delete_entry: "Slette denne loggføringen helt og permanent? Dette kan ikke angres.",
    ...
    beredskap: "Beredskapsnivå",
    scene_farge: "Scenefarge",
    ...
    confirm_archive: "Dette vil slette arrangementet permanent (husk å eksportere til PDF først om du trenger det). Fortsette?",
  ...
  en: {
    ...
    mobile_webapp_link: "📱 Web app for mobile users",
    logout: "Log out",
    new_entry: "New log entry",
    entry_type_label: "Type",
    delete_entry: "Delete",
    confirm_delete_entry: "Permanently delete this log entry? This cannot be undone.",
    ...
    beredskap: "Preparedness level",
    scene_farge: "Stage color",
    ...
    confirm_archive: "This will permanently delete the event (export to PDF first if you need it). Continue?",
